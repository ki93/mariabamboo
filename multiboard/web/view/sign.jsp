...
<link rel="stylesheet" type="text/css"
	href="vendor/bootstrap/css.login/bootstrap.min.css">
<!--===============================================================================================-->
<link rel="stylesheet" type="text/css"
	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				...
				<form action="login.go" class="login100-form validate-form"
					id="formlogin" style="padding-bottom: 0px;" method="POST">
					...
					<div class="row">
						<div class="container-login100-form-btn">
							...
							<div class="col-sm-auto">
								<button form="formlogin" class="login100-form-btn">Login</button>
							</div>
							<div class="col-sm-2"></div>
							<div class="col-sm-auto">
								<button class="login100-form-btn"
									onclick="location.href='registerpage.go';">Sign Up</button>
							</div>
						</div>
					</div>
				</div>
